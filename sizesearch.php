		...
		<!-- Header -->
			<div id="header">
				<div class="container">
					...
					<!-- Logo -->
						<h1><a href="sizesearch.php" id="logo">Search by Size</a></h1>
							...
							<section>
								...
								//begin html form using the GET method, action sent to results.php
									echo"<div style='text-align:center;'><form method = 'GET' action = 'results.php'>
										<select name='size'>";
								//this variable pulls size ranges from size table in database				
								$listresult=mysqli_query($link, "SELECT * FROM size");
