		...
		<!-- Header -->
			<div id="header">
				<div class="container">
					...
					<!-- Logo -->
						<h1><a href="#" id="logo">Search by Color</a></h1>
							...
							<section>
								...
								//setting parameters for database connection  
									echo"<div style='text-align:center;'><form method = 'GET' action = 'results.php'>
										<select name='color'>";
								//this variable pulls color names from color table in database		
								$listresult=mysqli_query($link, "SELECT * FROM color");
									while ($row=mysqli_fetch_array($listresult)) {
									print "<option value='$row[color_id]'>$row[color]</option>";
											}
